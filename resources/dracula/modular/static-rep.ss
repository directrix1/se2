...
;;  (make-module/static ID ID Syntax (Listof SPort) (Listof SPort) (Listof Syntax))
;; A Static [Im/Ex]Port (SPort) is:
;;  (make-port/static Syntax SIfc (Listof (cons ID ID)) (Listof SPort))
